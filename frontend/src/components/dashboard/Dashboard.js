...
function Dashboard() {
  ...
  const checkApiHealth = async () => {
    try {
      ...
      if (data.status === 'healthy') toast.success('API Connected');
    } catch {
  ...
  const fetchDashboardStats = async () => {
    try {
      ...
      setStats({ totalScans: 1234, strokesDetected: 89, criticalCases: 12, accuracy: 94.2 });
    }
  };
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-6">
            <div className="flex items-center justify-between h-20">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white">NeuroSentry</h1>
        ...
        <main className="container mx-auto px-6 py-8 mt-20 relative z-10">
          <AnimatePresence mode="wait">
            {activeView==='dashboard' && <DashboardHome key="dashboard" stats={stats}/>}
            {activeView==='form' && <FormPrediction key="form"/>}
            {activeView==='scan' && <ScanAnalysis key="scan"/>}
            {activeView==='hospital' && <HospitalView key="hospital"/>}
          </AnimatePresence>
        </main>
